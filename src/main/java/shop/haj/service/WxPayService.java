...
public interface WxPayService {
   ...
   */
  WxPayOrderQueryResult queryOrder(String transactionId, String outTradeNo, String mchKey) throws WxErrorException;
   ...
   */
  WxPayOrderCloseResult closeOrder(String outTradeNo, String mchKey) throws WxErrorException;
   ...
   */
  WxPayUnifiedOrderResult unifiedOrder(WxPayUnifiedOrderRequest request, String mchKey) throws WxErrorException;
   ...
   * @param request 请求对象，注意一些参数如appid、mchid等不用设置，方法内会自动从配置对象中获取到（前提是对应配置中已经设置）
   */
  Map<String, String> getPayInfo(WxPayUnifiedOrderRequest request, String mchKey, int order_id) throws WxErrorException;

  /**
   * 获取配置
   */
  WxPayConfig getWxConfig(int shop_id);
   ...
   * @return 退款操作结果
   */
  WxPayRefundResult refund(WxPayRefundRequest request, SSLContext sslContext, String mchKey) throws WxErrorException;
   ...
   * @return 退款信息
   */
  WxPayRefundQueryResult refundQuery(String transactionId, String outTradeNo, String outRefundNo, String refundId, String mchKey)
   ...
   */
  WxPayOrderNotifyResult getOrderNotifyResult(String xmlData, String mchKey) throws WxErrorException;
   ...
   * @param request 请求对象
   */
  WxPaySendRedpackResult sendRedpack(WxPaySendRedpackRequest request, SSLContext sslContext) throws WxErrorException;
   ...
   */
  WxPayRedpackQueryResult queryRedpack(String mchBillNo, SSLContext sslContext, String mchKey) throws WxErrorException;
   ...
   * @param request 请求对象
   */
  WxEntPayResult entPay(WxEntPayRequest request, SSLContext sslContext, String mchKey) throws WxErrorException;
   ...
   */
  WxEntPayQueryResult queryEntPay(String partnerTradeNo, SSLContext sslContext, String mchKey) throws WxErrorException;
   ...
   * @return 生成的二维码的字节数组
   */
  byte[] createScanPayQrcodeMode1(String productId, File logoFile, Integer sideLength, String app_id, String mchId, String mchKey);
   ...
   * @return 生成的二维码URL连接
   */
  String createScanPayQrcodeMode1(String productId, String app_id, String mchId, String mchKey);
   ...
   * </pre>
   */
  void report(WxPayReportRequest request, String mchKey) throws WxErrorException;
   ...
   * @return 保存到本地的临时文件
   */
  File downloadBill(String billDate, String billType, String tarType, String deviceInfo, String mchKey) throws WxErrorException;
   ...
   * </pre>
   */
  WxPayMicropayResult micropay(WxPayMicropayRequest request, String mchKey) throws WxErrorException;
   ...
   * </pre>
   */
  WxPayOrderReverseResult reverseOrder(WxPayOrderReverseRequest request, SSLContext sslContext, String mchKey) throws WxErrorException;
   ...
   * @param request 请求对象
   */
  String shorturl(WxPayShorturlRequest request, String mchKey) throws WxErrorException;
   ...
   * @return openid
   */
  String authcode2Openid(WxPayAuthcode2OpenidRequest request, String mchKey) throws WxErrorException;
